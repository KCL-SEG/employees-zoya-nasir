...
class Employee:
    ...
    def __str__(self):
        ...
        if self.commission_type == "Bonus":
            commission_str += f"receives a bonus commission of {self.commission_amount} "
        elif self.commission_type == "Contract":
            commission_str += f"receives a commission for {self.contracts_landed} contract(s) at {self.commission_amount}/contract "
