...
class Employee:
    ...
    def get_pay(self):
        ...
        if self.commission_type == "Bonus":
            ...
            commission_pay = self.commission_rate
            commission_exp = (f" and receives a bonus commission of {self.commission_rate}.")
            ...
            commission_pay = self.commission_rate * self.contracts_landed
            commission_exp = (f" and receives a commission for {self.contracts_landed} contract(s) at {self.commission_rate}/contract.")
